...
const Cart = () => {
    const {products, currency, user, cartItems, setCartItems, removeFromCart, getCartCount, updateCartItem, getCartAmount, navigate, axios} = useAppContext();
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("/add-address")} className="text-primary
                                 text-center cursor-pointer p-2 hover:bg-indigo-500/10">
                                    Add address
                                </p>
                            </div>
                        )}
